...
export class FormaDePagamentoService {
  ...
  doSupermercado(supermercado): Observable<any> {
    return this.http.get(`${this.API}/supermercados/${supermercado.id}/formas-de-pagamento`);
  }

  adicionaAoSupermercado(formaDePagamento): Observable<any> {
    return this.http.post(`${this.API}/parceiros/supermercados/${formaDePagamento.supermercado.id}/formas-de-pagamento`, formaDePagamento);
  }

  removeDoSupermercado(formaDePagamento) {
    return this.http.delete(`${this.API}/parceiros/supermercados/${formaDePagamento.supermercado.id}/formas-de-pagamento/${formaDePagamento.id}`);
  }
